...
export default defineConfig({
  ...
  webServer: [
    ...
    { command: 'npm run dev -- --port 3011', url: 'http://127.0.0.1:3011', env: { PROXY_SHARED_SECRET: 'test-only-browser-proxy-secret', API_BASE_URL: 'http://127.0.0.1:8011', NEXT_TELEMETRY_DISABLED: '1' }, timeout: 120000, reuseExistingServer: false },
  ],
})
